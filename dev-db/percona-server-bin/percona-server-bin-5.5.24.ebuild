...
C_X86_URI="${BASE_URI}/${C_MY_PKG}/${PV}-${C_RELEASE}6/binary/linux/i686/${C_MY_PKG}-${PV}-${C_RELEASE}.${C_BUILD_NUMBER}.Linux.i686.tar.gz"
C_X86_64_URI="${BASE_URI}/${C_MY_PKG}/${PV}-${C_RELEASE}6/binary/linux/x86_64/${C_MY_PKG}-${PV}-${C_RELEASE}.${C_BUILD_NUMBER}.Linux.x86_64.tar.gz"
