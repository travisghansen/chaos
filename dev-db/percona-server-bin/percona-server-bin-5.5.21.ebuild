...
SRC_URI="x86? ( http://www.percona.com/redir/downloads/${MY_PKG}-${MAJOR_MINOR}/${MY_PKG}-${PV}-${RELEASE}/binary/linux/i686/${MY_PKG}-${PV}-rel${RELEASE}-${BUILD_NUMBER}.Linux.i686.tar.gz )
		 amd64? ( http://www.percona.com/redir/downloads/${MY_PKG}-${MAJOR_MINOR}/${MY_PKG}-${PV}-${RELEASE}/binary/linux/x86_64/${MY_PKG}-${PV}-rel${RELEASE}-${BUILD_NUMBER}.Linux.x86_64.tar.gz ) "
