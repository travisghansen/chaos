...
..."
	einfo ""
	einfo "an env.d file has been installed to /etc/env.d/90percona-server-bin"
	einfo "making the percona binary path takes precedence over standard mysql"
	einfo "if this is not desired simply comment the lines out in the file"
	einfo ""
	einfo "you could also place the same logic into your .bashrc"
	einfo "please run 'source /etc/profile && env-update' to reload your current shell"
