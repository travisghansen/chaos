...
MY_P="win8"
MY_SRC_FILE="155025-win8.tar.gz"
DESCRIPTION="Windows 8 cursor theme"
HOMEPAGE="http://gnome-look.org/content/show.php/Windows+8+cursors?content=155025"
SRC_URI="http://www.gnome-look.org/CONTENT/content-files/${MY_SRC_FILE}"
